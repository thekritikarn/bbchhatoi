...
export default function FacilitiesSection({ isPreview = false }) {
  const facilities = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0A1.5 1.5 0 003 16.5v-9C3 6.12 4.12 5 5.5 5S8 6.12 8 7.5V12m13 3.546V9" />
          <path d="M12 12H8" />
        </svg>
      ),
    },
      ...
      <div className="container">
        <ScrollReveal className="text-center reveal" style={{ marginBottom: "var(--space-3xl)" }}>
          ...
          <p className="section-subtitle">
            Our campus is equipped with modern facilities to ensure a comfortable and productive learning experience.
          </p>
        </ScrollReveal>
