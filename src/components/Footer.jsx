            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-4">
                ...
                <span>
                  ...
                  <a href="tel:+918637264915" className="hover:text-gold transition-colors">+91 8637264915</a> (School)<br />
                  <a href="tel:+919668183662" className="hover:text-gold transition-colors">+91 9668183662</a> (Admission)<br />
              ...
              <li className="flex items-start gap-4">
                ...
                <span>
                  ...
                  <a href="mailto:bbchhatoihss@gmail.com" className="hover:text-gold transition-colors">bbchhatoihss@gmail.com</a> (School)<br />
                  <a href="mailto:uniquesangram1@gmail.com" className="hover:text-gold transition-colors">uniquesangram1@gmail.com</a> (Admission)
                </span>
              </li>
            </ul>
          </div>
