      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-about">
            ...
            <p>
              Named after Late Shri Bhramarbar Chhatoi, our institution is dedicated to empowering rural and tribal students through quality and affordable education under CHSE, Odisha.
            </p>
            <div className="footer-social">
              ...
              <a href="https://www.instagram.com/bbchhatoihss" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                <svg fill="currentColor" viewBox="0 0 24 24">
